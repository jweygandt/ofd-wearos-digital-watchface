...
package com.ofd.sunrisesunset;

import com.ofd.sunrisesunset.calculator.SolarEventCalculator;
...
// Originall part of https://github.com/mikereedell/sunrisesunsetlib-java
...
public class SunriseSunsetCalculator {
     ...
     *            time zones.
     */
    public SunriseSunsetCalculator(SSLocation location, String timeZoneIdentifier) {
     ...
     */
    public SunriseSunsetCalculator(SSLocation location, TimeZone timeZone) {
        this.location = location;
    ...
    public static Calendar getSunrise(double latitude, double longitude, TimeZone timeZone, Calendar date, double degrees) {
        SolarEventCalculator solarEventCalculator = new SolarEventCalculator(new SSLocation(latitude, longitude), timeZone);
