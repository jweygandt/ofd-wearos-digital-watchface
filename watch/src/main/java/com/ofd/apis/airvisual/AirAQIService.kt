...
object AirAQIService2 : AQIService<AirAQIService2.AirAQIAQIDetails>() {
    ...
    class AirAQIAQIDetails(
        ...
        init {
            this.aqistr = aqippm.toString() + " Appm"
    ...
    override fun needToIterate(r: AQIResult<AirAQIAQIDetails>): Boolean {
    ...
    override suspend fun makeResult(
        ...
        if (sensors.isNotEmpty()) {
            ...
            val s0 = sensors.filter { s -> s.location_type.equals("outside") }
                .sortedWith(sortByClosest(calculator))
            ...
            val pm25 = sortedByPM25[min(inx, sortedByPM25.size - 1)].pm25
...
//
    ...
    private class DistanceCalculator(private val location: APILocation) {
        private val tempLocation = Location("AirAQI")

        private val distanceCache: MutableMap<PASensor, Float> = mutableMapOf()
        ...
        fun calculateDistanceTo(sensor: PASensor?): Float {
            try {
                ...
                distanceCache[sensor] = distanceTo[0]
