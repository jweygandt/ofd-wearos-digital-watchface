...
package com.ofd.sunrisesunset.calculator;

import com.ofd.sunrisesunset.Zenith;
...
public class SolarEventCalculator {
    final private SSLocation location;
     ...
     *            "America/New_York".
     */
    public SolarEventCalculator(SSLocation location, String timeZoneIdentifier) {
     ...
     */
    public SolarEventCalculator(SSLocation location, TimeZone timeZone) {
        this.location = location;
